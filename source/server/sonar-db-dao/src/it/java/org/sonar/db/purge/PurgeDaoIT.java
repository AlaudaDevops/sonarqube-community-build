...
project.getProjectDto().getUuid()), PurgeListener.EMPTY, new PurgeProfiler());
  ...
  void close_issues_clean_index_and_file_sources_of_disabled_components_specified_by_uuid_in_configuration() {
    ...
    db.measures().insertMeasure(srcFile,
      m -> m.addValue(metric1.getKey(), RandomUtils.nextInt(0, 50)).addValue(metric2.getKey(), RandomUtils.nextInt(0, 50)));
...
project.getProjectDto().getKey());
  ...
  void delete_measures_when_deleting_project() {
    ...
    db.measures().insertMeasure(project1, m -> m.addValue(metric.getKey(), RandomUtils.nextInt(0, 50)));
    db.measures().insertMeasure(dir1, m -> m.addValue(metric.getKey(), RandomUtils.nextInt(0, 50)));
    ...
    db.measures().insertMeasure(project2, m -> m.addValue(metric.getKey(), RandomUtils.nextInt(0, 50)));
    db.measures().insertMeasure(dir2, m -> m.addValue(metric.getKey(), RandomUtils.nextInt(0, 50)));
